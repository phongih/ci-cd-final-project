...
def test_read(client):
    client.post(
        "/products",
        json={"name": "Toy", "category": "toys", "available": True},
    )
...
def test_update(client):
    client.post(
        "/products",
        json={"name": "Book", "category": "books", "available": True},
    )
...
def test_delete(client):
    client.post(
        "/products",
        json={"name": "Laptop", "category": "electronics", "available": True},
    )
...
def test_list_all(client):
    client.post(
        "/products",
        json={"name": "Pen", "category": "stationery", "available": True},
    )
...
def test_list_by_name(client):
    client.post(
        "/products",
        json={"name": "Phone", "category": "electronics", "available": True},
    )
...
def test_list_by_category(client):
    client.post(
        "/products",
        json={"name": "TV", "category": "electronics", "available": True},
    )
...
def test_list_by_availability(client):
    client.post(
        "/products",
        json={"name": "Chair", "category": "furniture", "available": True},
    )
